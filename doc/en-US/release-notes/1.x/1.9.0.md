<!-- Language: en-US -->
<p><a href="./README.md">📋 All Releases</a> <span style="float:right"><b>English</b> | <a href="../../zh-CN/release-notes/1.9.0.md">简体中文</a></span></p>
...
- `ChatConfig.ReasoningEffort` → `ChatConfig.ReasoningEffortId`
- `Model.ApiType` → `Model.ApiTypeId`
...
- 📖 [1.8.1 Release Notes](./1.8.1.md) - Learn about previous version updates
- 📖 [Anthropic API Documentation](https://docs.anthropic.com/en/api/messages) - Official Messages API reference
- 📖 [OpenAI Images API Documentation](https://platform.openai.com/docs/api-reference/images) - Official image API reference

### Community Support

- 🐛 [Report Issues](https://github.com/sdcb/chats/issues)
- 💬 [Join Discussions](https://github.com/sdcb/chats/discussions)
- 📧 Contact Author: [https://github.com/sdcb](https://github.com/sdcb)
...
- ✅ Anthropic model provider support (ID=20)
- ✅ Anthropic Messages API compatible interface (/v1/messages)
- ✅ Anthropic Token count API (/v1/messages/count_tokens)
- ✅ OpenAI image generation API (/v1/images/generations)
- ✅ OpenAI image edit API (/v1/images/edits)
- ✅ Build developer pages (API Keys / Docs / Usage)
- ✅ API key masking display
- ✅ ChatInput expand/collapse/fullscreen animation
- ✅ UserMenuPopover animation effects
- ✅ ToolCallBlock header animation
- ✅ Model.SupportsVisionLink field

### Architecture Improvements

- ✅ Upgraded to .NET 10
- ✅ ChatService architecture refactor (DB Steps driven)
- ✅ New StepContentThink table supporting Claude signature
- ✅ ChatService changed to DI singleton registration
- ✅ Unified UserMenuPopover component

### Bug Fixes

- ✅ Fixed thinking budget not applying issue
- ✅ Fixed Gemini unable to chat after enabling thinking
- ✅ Fixed ChatInput height reset issue
- ✅ Fixed UserMessage sub-pixel line issue
- ✅ Fixed ToolCallBlock auto-expand anomaly
- ✅ Fixed FilePreview missing in non-fullscreen mode
- ✅ Fixed Anthropic API tool call finish reason
- ✅ Disabled Google Gemini retry to work around upstream bug

### Database Migration

- ✅ Create StepContentThink table (with Signature field)
- ✅ Migrate reasoning data
- ✅ Remove StepContentType/FileContentType/ChatRole tables
- ✅ Add Model.MaxThinkingBudget field
- ✅ Add ChatConfig.ThinkingBudget field
- ✅ Add Model.SupportsVisionLink field
- ✅ Field renaming (ApiType→ApiTypeId, ReasoningEffort→ReasoningEffortId)
