<!-- Language: en-US -->
<p><a href="./README.md">📋 All Releases</a> <span style="float:right"><b>English</b> | <a href="../../zh-CN/release-notes/1.8.1.md">简体中文</a></span></p>
...
- `DBModelProvider.AzureOpenAI` → `DBModelProvider.AzureAIFoundry` (enum value remains 1)
- `AzureChatCompletionService` → `AzureAIFoundryChatService` (class rename)
- Icon update: `azure-openai.svg` → `azure-ai-foundry.svg`
...
- Simplified URL fallback logic: `ModelKey.Host` → `ModelProviderInfo.GetInitialHost`
...
- 📖 [1.8.0 Release Notes](./1.8.0.md) - Learn about previous major architecture changes
- 📖 [1.8.0 API Changes](../1.8.0-api-changes.md) - Detailed API interface changes
- 📖 [Build Documentation](../build.md) - How to build and deploy
- ☁️ [Azure Deployment Documentation](../azure-bicep.md) - How to deploy to Azure
...
### Application Export & Embedding

- **Standalone App Export**: Support exporting chat functionality as standalone web applications
- **JS Script Integration**: Provide embeddable JS scripts that can be integrated into customer websites
- **Fixed Configuration Mode**: Use preset Chat Config focused on specific business scenarios
- **Dify-like Experience**: Enable users to quickly integrate AI capabilities into their own products

> Note: This feature will be developed after MCP capability enhancements are completed
