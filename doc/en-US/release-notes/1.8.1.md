...
- Improved support for modern image formats (HEIC/AVIF/WebP)
...
- Fixed compilation errors caused by user model permission page
- Fixed TypeScript type definition issues
- Ensured codebase compiles successfully
