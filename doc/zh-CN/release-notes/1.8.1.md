<!-- Language: zh-CN -->
<p><a href="./README.md">📋 所有版本</a> <span style="float:right"><a href="../../en-US/release-notes/1.8.1.md">English</a> | <b>简体中文</b></span></p>
...
- **独立应用导出**：支持将聊天功能导出为独立的网页应用
- **JS 脚本集成**：提供嵌入式 JS 脚本，可集成到客户网站中
- **固定配置模式**：使用预设的 Chat Config，专注于特定业务场景
- **类似 Dify 的体验**：让用户可以快速将 AI 能力集成到自己的产品中

> 注：此功能将在 MCP 能力增强完成后开发
