...
var IconFolder = (props: IconProps) => {
  const { className, size = 20, strokeWidth = 1.6, stroke, onClick } = props;
...
var IconReasoning = (props: IconProps) => {
  const { className, size = 20, strokeWidth = 0, stroke, onClick } = props;
...
var IconDesktop = (props: IconProps) => {
  const { className, size = 20, strokeWidth = 1.6, stroke, onClick } = props;
...
var IconChartHistogram = (props: IconProps) => {
  const { className, size = 20, strokeWidth = 1.6, stroke, onClick } = props;
...
var IconArrowsDiagonal = (props: IconProps) => {
  const { className, size = 20, strokeWidth = 1.6, stroke, onClick } = props;
...
var IconArrowsDiagonalMinimize = (props: IconProps) => {
  const { className, size = 20, strokeWidth = 1.6, stroke, onClick } = props;
...
var IconEraser = (props: IconProps) => {
  const { className, size = 20, strokeWidth = 1.6, stroke, onClick } = props;
...
var IconArrowCompactDown = (props: IconProps) => {
  const { className, size = 20, strokeWidth = 1.6, stroke, onClick } = props;
