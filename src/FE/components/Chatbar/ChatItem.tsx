...
const ChatItem = ({ chat, onDragItemStart }: Props) => {
    ...
    <div className="relative flex items-center rounded-lg">
      {isChanging && selectChatId === chat.id ? (
        ...
        >
          ...
          <div
            className={`relative max-h-5 flex-1 overflow-hidden text-ellipsis whitespace-nowrap text-sm break-all text-left ${
