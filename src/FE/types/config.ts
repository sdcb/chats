...
export const createDefaultRequestTraceDirectionConfig = () => ({
  enabled: false,
  sampleRate: 1,
  retentionDays: 30,
  filters: {
  ...
  body: {
    ...
    redactJsonFields: ['password', 'token', 'secret', 'apiKey', 'access_token', 'refresh_token', 'id_token'],
  },
});
...
export const GlobalDefaultConfigs = {
  ...
  inboundRequestTrace: createDefaultRequestTraceDirectionConfig(),
  outboundRequestTrace: createDefaultRequestTraceDirectionConfig(),
};
