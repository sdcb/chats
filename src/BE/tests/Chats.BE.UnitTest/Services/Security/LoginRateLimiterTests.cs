...
public class LoginRateLimiterTests
{
    ...
    public async Task CheckPasswordAsync_AllowsWhenBelowThreshold()
    {
        ...
        LoginRateLimiter.RateLimitCheckResult result = await limiter.CheckPasswordAsync(clientInfo.Id, CancellationToken.None);
    ...
    public async Task CheckPasswordAsync_AggregatesAttemptsByIp()
    {
        ...
        LoginRateLimiter.RateLimitCheckResult result = await limiter.CheckPasswordAsync(secondClientInfo.Id, CancellationToken.None);
    ...
    public async Task CheckSmsAsync_IgnoresSuccessfulAttempts()
    {
        ...
        LoginRateLimiter.RateLimitCheckResult result = await limiter.CheckSmsAsync(clientInfo.Id, CancellationToken.None);
