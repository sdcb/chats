    ...
    public static ChatPresetDto FromDB(ChatPreset preset, IUrlEncryptionService idEncryption)
    {
        ...
        return new ChatPresetDto
        {
            ...
            Spans = [.. preset.ChatPresetSpans.Select(x => new ChatSpanDto
            {
                ...
                ModelName = x.ChatConfig.Model == null ? null : x.ChatConfig.Model.CurrentSnapshot.Name,
                ModelProviderId = x.ChatConfig.Model == null ? null : x.ChatConfig.Model.CurrentSnapshot.ModelKeySnapshot.ModelProviderId,
