...
VALUES 
    -- 文本模型
    (1600, 16, 'doubao-1.5-pro-32k-250115', 'Doubao-1.5-Pro', '2025/01/15', 0, 2, 0, 0, 1, 1, 0, 32000, 12288, NULL, 0.8, 2.0, 'RMB'),
    (1601, 16, 'doubao-1.5-pro-256k-250115', 'Doubao-1.5-Pro', '2025/01/15', 0, 2, 0, 0, 1, 1, 0, 256000, 12288, NULL, 5, 9, 'RMB'),
    (1602, 16, 'doubao-1.5-lite-32k-250115', 'Doubao-1.5-Lite', '2025/01/15', 0, 2, 0, 0, 1, 1, 0, 32000, 12288, NULL, 0.3, 0.6, 'RMB'),
    (1603, 16, 'deepseek-r1-250120', 'DeepSeek-R1', '2025/01/20', 0, 2, 0, 0, 1, 1, 1, 64000, 16384, NULL, 4, 16, 'RMB'),
    (1604, 16, 'deepseek-r1-distill-qwen-32b-250120', 'DeepSeek-R1', '2025/01/20', 0, 2, 0, 0, 1, 1, 1, 32000, 8192, NULL, 1.5, 6, 'RMB'),
    (1605, 16, 'deepseek-r1-distill-qwen-7b-250120', 'DeepSeek-R1', '2025/01/20', 0, 2, 0, 0, 1, 1, 1, 32000, 8192, NULL, 0.6, 2.4, 'RMB'),
    (1606, 16, 'deepseek-v3-241226', 'DeepSeek-V3', '2025/01/20', 0, 2, 0, 0, 1, 1, 0, 64000, 16384, NULL, 2, 8, 'RMB'),

    -- 视觉模型
    (1607, 16, 'doubao-1.5-vision-pro-32k-250115', 'Doubao-1.5-Vision-Pro', '2025/01/15', 0, 2, 0, 1, 1, 1, 0, 32000, 12000, NULL, 3, 9, 'RMB');
GO
